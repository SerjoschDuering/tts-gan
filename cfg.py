...
def parse_args():
    ...
    parser.add_argument('-gen_bs', '--gen_batch_size', type=int, default=64,
                        help='size of the generator batches')
    parser.add_argument('-dis_bs', '--dis_batch_size', type=int, default=64,
                        help='size of the discriminator batches')
    ...
    parser.add_argument('--patch_size', type=int, default=4,
                        help='Discriminator patch size')
    parser.add_argument('--fid_stat', type=str, default="None",
                        help='FID statistics file')
    ...
    parser.add_argument('--ema', type=float, default=0.995,
                        help='ema')
    parser.add_argument('--ema_warmup', type=float, default=0.0,
                        help='ema warm up')
    ...
    parser.add_argument('--g_window_size', type=int, default=8,
                        help='generator window size')
    parser.add_argument('--d_window_size', type=int, default=8,
                        help='discriminator window size')
    ...
    # New: Encoder configuration arguments
    parser.add_argument('--enc_patch_size', type=int, default=2,
                        help='Encoder patch size')
    parser.add_argument('--enc_emb_size', type=int, default=64,
                        help='Encoder embedding size')
    parser.add_argument('--enc_seq_length', type=int, default=2190,
                        help='Encoder sequence length')
    parser.add_argument('--enc_depth', type=int, default=8,
                        help='Encoder transformer depth')
    parser.add_argument('--enc_num_heads', type=int, default=4,
                        help='Encoder number of attention heads')
    parser.add_argument('--enc_latent_dim', type=int, default=1000,
                        help='Encoder latent space dimension')
    parser.add_argument('--enc_drop_p', type=float, default=0.1,
                        help='Encoder dropout probability')
    parser.add_argument('--enc_forward_drop_p', type=float, default=0.1,
                        help='Encoder feed-forward dropout probability')
